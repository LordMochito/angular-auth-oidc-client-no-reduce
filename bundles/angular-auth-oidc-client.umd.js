(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('jsrsasign'), require('@angular/common/http'), require('@angular/router'), require('rxjs'), require('rxjs/operators'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('angular-auth-oidc-client', ['exports', '@angular/common', 'jsrsasign', '@angular/common/http', '@angular/router', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global['angular-auth-oidc-client'] = {}),global.ng.common,global.jsrsasign,global.ng.common.http,global.ng.router,global.rxjs,global.rxjs.operators,global.ng.core));
}(this, (function (exports,common,jsrsasign,http,router,rxjs,operators,i0) { 'use strict';
